...
import { getGoogleProductCategory, updateGoogleProductCategory } from 'src/actions/google';
...
export function GoogleEditView({ id }) {
  ...
  const fetchData = useCallback(async () => {
    try {
      const data = await getGoogleProductCategory(id);
      if (data) {
        reset({
  ...
  const onSubmit = handleSubmit(async (data) => {
    try {
      const result = await updateGoogleProductCategory(id, data);
