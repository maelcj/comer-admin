...
export function TablaAgregarProductosRelacionados({ refaccion, handleGetProductosRelacionados }) {
  ...
  const handleAgregarProductoRelacionado = async (id_producto) => {
    setIsLoading(true);
    const res = await agregarProductoRelacionado(id_producto, refaccion.id);
  ...
  const fetchTableData = useCallback(async () => {
    setIsLoading(true);
    const data = await getTablaAgregarProductosRelacionados(paginationModel, debounceFilterModel);
    setRows(data.rows);
