...
export const endpoints = {
  ...
  productos: {
    ...
    actualizarFichaDescripcion: '/api/admin/productos/actualizarFichaDescripcion',
    actualizarFichaCampos: '/api/admin/productos/actualizarFichaCampos',
    ...
    getImagenes: '/api/admin/productos/getImagenes',
    getOfertasTemporales: '/api/admin/productos/getOfertasTemporales',
    getProductosRelacionadosSimilares: '/api/admin/productos/getProductosRelacionadosSimilares',
    getCampos: '/api/admin/productos/getCampos',
